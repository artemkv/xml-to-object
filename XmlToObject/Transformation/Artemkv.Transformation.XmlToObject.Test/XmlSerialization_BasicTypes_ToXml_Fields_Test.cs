...
{
	/// <summary>
	/// Checks that all fields can be serialized to Xml.
	...
	/// </summary>
	[TestFixture]
	public class XmlSerialization_BasicTypes_ToXml_Fields_Test
	{
		#region To Xml

		[TestCase]
		public void TestStringFieldToXml()
		{
			var serializable = new WithStringField()
			{
				AnyString = "MyString"
			};
		...
		[TestCase]
		public void TestCharFieldToXml()
		{
			var serializable = new WithCharField()
			{
				AnyChar = 'A'
			};
		...
		[TestCase]
		public void TestNumericFieldToXml()
		{
			var serializable = new WithNumericField()
			{
		...
		[TestCase]
		public void TestFloatPointNumericFieldToXml()
		{
			var serializable = new WithFloatPointNumericField()
			{
		...
		[TestCase]
		public void TestDecimalFieldToXml()
		{
			var serializable = new WithDecimalField()
			{
		...
		[TestCase]
		public void TestBooleanFieldToXml()
		{
			var serializable = new WithBooleanField()
			{
				BoolTrue = true,
				BoolFalse = false
			};
		...
		[TestCase]
		public void TestDateTimeFieldToXml()
		{
			var expectedDate = new DateTime(2012, 10, 13, 16, 30, 55, 123);
			var serializable = new WithDateTimeField()
			{
		...
		[TestCase]
		public void TestByteArrayFieldToXml()
		{
			var serializable = new WithByteArrayField()
			{
